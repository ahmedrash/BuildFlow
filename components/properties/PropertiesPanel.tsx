                                ...
                                <div className="space-y-6">
                                    ...
                                    {displayElement.type === 'image' && (
                                     ...
                                     {['section', 'container', 'columns'].includes(displayElement.type) && (
                                          <div className="flex items-center justify-between mt-4 border border-gray-100 bg-gray-50 p-2 rounded">
                                            <label className="text-[10px] text-gray-600 font-bold">Parallax Effect</label>
                                            <input 
                                                type="checkbox"
                                                className="accent-indigo-600 w-3 h-3"
